...
const promptForMissingOptions = async options => {
    ...
    if (options.action === 'create') {
        ...
        const rizeQuestions = [
        {
            ...
            name: 'rizeHosts',
            type: 'input',
            message: 'Please input message queue host(s). (comma delimited if more then one)',
            default: ''
        }, {
            name: 'rizeTopic',
            type: 'input',
            message: 'Please input message queue Topic',
            default: ''
        }, {
            name: 'rmqUsername',
            type: 'input',
...
const createEnv = async (options) => {
    ...
    const object = {
        ...
        RMQ_HOSTS: options.rizeHosts,
        RMQ_TOPIC: options.rizeTopic,
