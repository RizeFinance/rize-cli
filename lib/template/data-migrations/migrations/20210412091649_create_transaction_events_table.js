...
exports.up = async (knex) => {
    ...
    await knex.raw(`
        ...
        ADD CONSTRAINT FK_transaction_events_source_custodial_account_uid FOREIGN KEY (source_custodial_account_uid) REFERENCES ${schema}.custodial_line_items(uid),
        ADD CONSTRAINT FK_transaction_events_destination_custodial_account_uid FOREIGN KEY (destination_custodial_account_uid) REFERENCES ${schema}.custodial_line_items(uid);
    `);
};
