...
exports.up = async (knex) => {
    await knex.raw(`
        CREATE TABLE ${schema}.debit_cards(
            ...
            shipping_address_street1 VARCHAR(255) NULL,
            shipping_address_street2 VARCHAR(255) NULL,
            shipping_address_city VARCHAR(255) NULL,
            shipping_address_state VARCHAR(255) NULL,
            shipping_address_postal_code VARCHAR(10) NULL
        );
    `);
