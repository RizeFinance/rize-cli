...
exports.up = async (knex) => {
    ...
    await knex.raw(`
        ...
        ADD CONSTRAINT FK_synthetic_accounts_closed_to_synthetic_account_uid FOREIGN KEY (closed_to_synthetic_account_uid) REFERENCES ${schema}.synthetic_account_types(uid);
    `);
};
