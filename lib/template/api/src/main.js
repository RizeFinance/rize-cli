...
Promise
    .all([
        ...
        rizeProvider.rmq.connect(config.rmq.clientId, config.rmq.username, config.rmq.password),
    ])
    .then(([
        listenResponse, // eslint-disable-line
        corsResponse, // eslint-disable-line
        rmqClient
    ]) => {
        /**
         * Init middlewares
