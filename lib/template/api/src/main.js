...
Sentry.init({
    dsn: 'https://41aa27feaead4399ac2642a5ce6388e7@o56811.ingest.sentry.io/6056578',
    environment: config.rize.environment,
...
Promise
    ...
    .then(() => {
         ...
         */
        const rmqClient = rizeProvider.rmq.connect(config.rmq.hosts, config.rmq.clientId, config.rmq.topic, config.rmq.username, config.rmq.password, { maxReconnects: -1 });
        ...
        app.use('/documents', documentComponent);
