...
module.exports = function TransferRouter(
    ...
    router.get('/', authGuard, paginationSanitizer, transferValidator.validateGetList, (req, res, next) => {
        const {
            limit,
            offset,
        ...
        transferController.getTransfers(req.user.sub, limit, offset, synthetic_account_uid)
            .then((data) => {
