...
module.exports = (
    ...
    const syntheticAccountService = new SyntheticAccountService(dbProvider, rizeProvider, accountAuthProvider);
    const poolService = new PoolService(dbProvider, rizeProvider);
    const custodialAccountService = new CustodialAccountService(dbProvider, rizeProvider);
