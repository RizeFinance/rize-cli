...
class CustomerService {
    ...
    */
    ...
    async getCustomerProducts(customerUid) {
        return await this._rizeProvider.customerProduct.getList({ customer_uid: [customerUid] });
    }
    ...
    async answerProfileQuestions(customerUid, answers) {
        return await this._rizeProvider.customer.updateProfileAnswers(customerUid, answers);
    }
