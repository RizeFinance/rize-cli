...
module.exports = (
    ...
    const complianceWorkflowService = new ComplianceWorkflowService(dbProvider);

    /* Instantiate the controllers */
    const complianceWorkflowController = new ComplianceWorkflowController(complianceWorkflowService);
